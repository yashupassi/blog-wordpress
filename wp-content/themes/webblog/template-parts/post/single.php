...
<div class="box">
	<div>
  		<div class="side-buttons">
            ...
            <a class="fb"  href=<?php echo "//www.facebook.com/sharer/sharer.php?u=".get_post_permalink();?>>
       				<li style="margin-top: 10px"><i class="fa fa-facebook facebook-li" style="padding-left:14px"></i></li>
            </a>
            <a class="twt" href=<?php echo "//twitter.com/home?status=".get_post_permalink();?>>
       				<li><i class="fa fa-twitter"style="padding-left:11px"></i></li>
            </a>
            <a class="link" href=<?php echo "//www.linkedin.com/shareArticle?mini=true&title=&summary=&source=&url=".get_post_permalink();?>>
