...
class ap_login_form{
	...
	public function loginForm( $wid_id = '' ){
		...
		?>
		<div id="log_forms" <?php echo $wid_id;?>">
		...
		<div class="log-form-group">
			...
			<input type="text" name="userusername" class="name-box" placeholder="Username*" id="userusername" required <?php do_action( 'lwws_userusername_field' );?>/>
		</div>
		<div class="log-form-group">
			<!--<label for="userpassword"><?php _e('Password','login-sidebar-widget');?> </label>-->
			<input type="password" name="userpassword" class="name-box" placeholder="Password*" id="userpassword" required <?php do_action( 'lwws_userpassword_field' );?>/>
		</div>
		...
		<div class="log-form-group"><input name="login" type="submit" class="btn-rectangle" value="<?php _e('Login','login-sidebar-widget');?>" <?php do_action( 'lwws_login_form_submit_tag' );?>/></div>
			<p><a href="#" id="Sign_Up" class="sign-up">Sign Up ? </a></p>
