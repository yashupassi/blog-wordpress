<div class="column">
                  ...
                  <?php $post= get_post( get_the_ID() ); ?>
                     <a href="?p=<?php echo get_the_ID(); ?>" ><img src=<?php the_post_thumbnail_url($post);?> style="width:100%" class="post-img"></a>
                     <div class="info">
                        <h1 class="ClanOT-Medium"><b><a href="?p=<?php echo get_the_ID();?>">
             <?php $title  = get_the_title();$title = strip_tags($title);echo substr($title, 0, 50); ?></a><b>...</b>
                        </h1>
                        <p class="ClanOT-Book">
