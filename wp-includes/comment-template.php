...
function comment_form( $args = array(), $post_id = null ) {
	...
	$buttonInputHtml = "";
	if(is_user_logged_in()){
		$buttonInputHtml =  '<input name="%1$s" type="submit" id="%2$s" class="%3$s" value="%4$s" />';
	}else{
		$buttonInputHtml =  '<input name="%1$s" type="button" id="myBtn" class="%3$s not-loggedin" class="post_comment" value="%4$s" />';
	}
	if ( is_user_logged_in() ):
	...
	$defaults = array(
		...
		<div class="add-cmnt">
		<div class="user-icon" style="margin-top:12px;">'
